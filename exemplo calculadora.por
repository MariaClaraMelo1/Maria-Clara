...
//se nas quatro operações o usário digitar um número negativo, mostrar a mensagem "Não fazemos operações com números negativos"
//se o usuário digitar letras, mostrar a mensagem "Número inválido, por favor digite outro número"
//resolver a questão do resto das divisões
//arrendondar caso o usuário digitar número com casa decimal
